...
export default function ProductPage() {
                ...
                if (productResponse.result === 'success') {
                    ...
                    if (reviewsResponse.result === 'success') {
                        ...
                        if (reviewsResponse.data.length > 0) {
                            const totalRating = reviewsResponse.data.reduce((accumulator, currentReview) => accumulator + currentReview.rating, 0);
    ...
    if (isLoading) return <div className="loadingContainer"><div className="loader"></div></div>;
    if (!product) return <div className="errorContainer">A termék nem található.</div>;
            ...
            <div className="productPageContainer">
                ...
                <div className="productMainLayout">
                    <div className="leftColumn">
                        <div className="imageWrapper">
                            ...
                            {product.conditionState && (
                                <span className={`conditionBadgeLarge ${product.conditionState}`}>
                                    {product.conditionState}
                                </span>
                            )}
                        </div>
                    ...
                    <div className="rightColumn">
                        ...
                        <div className="ratingBlock" onClick={() => setShowReviewModal(true)}>
                            <div className="stars">
                        ...
                        <div className="priceBlock">
                            <span className="currentPrice">{formatPrice(product.productPrice)} Ft</span>
                        ...
                        <div className="availabilityBlock">
                            ...
                            <div className="availabilityItem">
                                <span className="checkIcon">✔</span> 
                                <span className="availabilityText">Azonnal szállítható</span>
                            </div>
                        </div>

                        <div className="actionBlock">
                            <button className="addToCartBtnBig" onClick={addToCart}>
                                Kosárba
                            </button>
                        </div>

                        {loginMessage && (
                            <div className={`messageToast ${loginMessage.includes('✅') ? 'success' : 'error'}`}>
                                {loginMessage}
                            </div>
                        )}
                ...
                <div className="additionalInfoSection">
                    ...
                    <div className="infoBox">
                        ...
                        <ul>
                            <li>Erre a termékre 24 hónap hivatalos gyártói garanciát vállalunk.</li>
                ...
                <div className="reviewsSection">
                    ...
                    {reviews.length === 0 ? (
                        <p className="noReviews">Ehhez a termékhez még nem érkezett vélemény.</p>
                    ) : (
                                ...
                                <div key={index} className="reviewCard">
                                    <div className="reviewHeader">
                                        <div className="reviewUser">
                                            ...
                                            <span className="userName">{review.userName || "Névtelen felhasználó"}</span>
                                        </div>
                                        <div className="reviewStars">
                                            <span className="starFilled">{'★'.repeat(review.rating)}</span>
                                            <span className="starEmpty">{'★'.repeat(5 - review.rating)}</span>
                                        </div>
                                    </div>
                                    <div className="reviewContent">
                                        <p>{review.review || review.comment || "Nincs szöveges értékelés."}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
