    ...
    return (
        <div className="adminUsedContainer">
            ...
            <div className="tabHeader">
                <button className={activeTab == 'incoming' ? 'tabButton active' : 'tabButton'} onClick={() => setActiveTab('incoming')}>Beérkezett leadások</button>
                ...
                {editingProduct && (
                    <div className="listingForm">
                        ...
                        <div className="formGroup">
                            ...
                            <input type="file" onChange={(e) => setListingImage(e.target.files[0])} style={{padding: '8px'}} />
                        </div>
                        
                        <div className="listingButtons">
                            <button className="acceptBtn" onClick={handleListProduct}>Mentés és Listázás</button>
                        ...
                        {activeTab == 'incoming' && incomingSubmissions.map(sub => (
                            <div key={sub.submissionId} className="adminSubCard">
                                <div className="adminCardImageArea">
                                    {sub.productImage ? (
                                        <img src={getImageUrl(sub.productImage)} alt="Termék" className="subImg" />
                                    ) : (
                                        <span className="noImagePlaceholder">Nincs feltöltött kép</span>
                                    )}
                                </div>
                                <div className="adminCardBody">
                                    ...
                                    <div className="dataTable">
                                        ...
                                        <div className="dataValue">{sub.userName} (ID: {sub.userId})</div>
                                        
                                        <div className="dataLabel">Állapot</div>
                                        <div className="dataValue highlight" style={{textTransform: 'capitalize'}}>{sub.conditionState}</div>
                                    </div>

                                    <div className="descBox">
                                        <div className="dataLabel" style={{marginBottom: '5px'}}>Leírás</div>
                                        <p>{sub.productDescription}</p>
                                    </div>
                                    
                                    <div className="offerActionArea">
                                        <div className="dataLabel" style={{marginBottom: '8px'}}>Ajánlat</div>
                        ...
                        {activeTab == 'waiting' && waitingListSubmissions.map(sub => (
                            <div key={sub.submissionId} className="adminSubCard">
                                ...
                                <div className="adminCardBody">
                                    ...
                                    <button className="acceptBtn fullWidthBtn" onClick={() => startListing(sub)}>
                                        Listázás indítása
                                    </button>
                                </div>
                            </div>
